...
- Portfolio materials now include architecture, data model, lifecycle, production mapping, decision log, and a concise portfolio brief.
...
| 2026-05-26 | Final documentation pass added portfolio brief, refreshed case study diagrams, current architecture, data model, tech stack, and portfolio talking points. |
